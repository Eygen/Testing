...
<div class="container">
    ...
    <div class="col-lg-4">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#group" data-toggle="tab" aria-expanded="true"><fmt:message key="by_group"/> </a></li>
            <li class=""><a href="#student" data-toggle="tab" aria-expanded="false"><fmt:message key="by_student"/> </a></li>
        </ul>
